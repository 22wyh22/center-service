...
import com.wyh.domain.service.ICommAsyncTaskService;
...
public class CommAsyncTaskAppService {
    ...
    private final ICommAsyncTaskService ICommAsyncTaskService;

    static {
        TASK_INFO_MAP.put("test", new TaskInfo("class","method"));
    }

    public CommAsyncTaskAppService(ICommAsyncTaskService ICommAsyncTaskService) {
        this.ICommAsyncTaskService = ICommAsyncTaskService;
    }
    ...
    public Object addCommAsyncTask(CommAsyncRequestDTO commAsyncRequestDTO) {
        ...
        return ICommAsyncTaskService.addCommAsyncTask(asyncTaskBO);
    }
}
